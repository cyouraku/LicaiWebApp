...
public class DateUtil {
	 ...
	 */
	public static Date getDateFormatted(String specifyDate){
//		String specifyDate = "2017-06-30";
...
//		System.out.println(formatted.toString());
	 ...
	 * return java.sql.Date
	 */
//	public static Date getDateFormatted(String specifyDate) throws ParseException{
//        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
//		Date date = (Date) sdf.parse(specifyDate);
//		return date;
//	}
...
//		int month =calendar.get(Calendar.MONTH) + 2;
		...
		int year = localDate.getYear();
		int month = localDate.getMonthValue();
		int day = localDate.getMonth().maxLength();
		localDate = LocalDate.of(year, month, day);
		return localDate.toString();
	}
...
//       	int day  = calendar.get(Calendar.DAY_OF_MONTH);
		...
		if(weekDay != 1){
			localDate = localDate.minusDays(weekDay);
		}
		return localDate.toString();
    }
...
//       	int day  = calendar.get(Calendar.DAY_OF_MONTH) + 7;
		...
		logger.info("weekDay = " + weekDay);
		if(weekDay != 7){
			localDate = localDate.plusDays( 7 - weekDay);
		}
		return localDate.toString();
    }
...
//       	int day  = calendar.get(Calendar.DAY_OF_MONTH);
		LocalDate localDate = LocalDate.now();
		int year = localDate.getYear();
		int month = localDate.getMonth().firstMonthOfQuarter().getValue();
		localDate = LocalDate.of(year, month, 1);
		return localDate.toString();
	}
...
//       	int day  = calendar.get(Calendar.DAY_OF_MONTH);
		LocalDate localDate = LocalDate.now();
		int year = localDate.getYear();
		int month = localDate.getMonth().firstMonthOfQuarter().getValue() + 2;
		int day = 0;
		localDate = LocalDate.of(year, month, 1);
		day = localDate.getMonth().maxLength();
		localDate = LocalDate.of(year, month, day);
		return localDate.toString();
	}
